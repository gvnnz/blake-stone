...
statetype s_electro_appear1 = {0, SPR_ELEC_APPEAR1, 14, nullptr, nullptr, &s_electro_appear2};
...
statetype s_liquid_fall3 = {0, SPR_LIQUID_R1, 15, nullptr, nullptr, &s_liquid_move};
...
statetype s_blake3 = {0, SPR_BLAKE_W3, 12, nullptr, nullptr, &s_blake4};
statetype s_blake4 = {0, SPR_BLAKE_W4, 12, nullptr, nullptr, &s_blake1};
        ...
        if (CheckLine(ob, player) && (!PlayerInvisable)) // got a shot at player?
        {
            ...
            case final_boss4obj:
                ...
                else
                {
                    ...
                    // Move half as  when doing near attacks...
                    //
...
statetype s_goldmorph3 = {false, SPR_GOLD_MORPH3, 10, nullptr, nullptr, &s_goldmorph4};
statetype s_goldmorph4 = {false, SPR_GOLD_MORPH4, 10, nullptr, nullptr, &s_goldmorph5};
